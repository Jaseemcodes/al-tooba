          ...
          {topRatedProducts.map((product, idx) => (
            ...
            >
                <TiltCard className="h-full">
                  <div className="group bg-[#FAF7F2] rounded-[16px] sm:rounded-[24px] p-3 flex flex-row md:flex-col h-full border border-[#D4A24C]/10 hover:border-[#D4A24C]/30 shadow-[0_8px_30px_rgba(13,59,42,0.03)] hover:shadow-[0_20px_40px_rgba(13,59,42,0.1)] transition-all duration-500 relative overflow-hidden gap-3 md:gap-0">
                    ...
                    {/* Image Container with a clean thin border (Left on mobile, Top on desktop) */}
                    <div className="relative w-2/5 md:w-full shrink-0 aspect-[4/5] rounded-[12px] sm:rounded-[16px] overflow-hidden bg-white md:mb-5 z-10 shadow-inner border border-gray-100 group/img">
